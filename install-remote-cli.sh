...
echo ""
echo "  # Wenn das Dashboard API_ACCESS_TOKEN setzt (REST-Absicherung):"
echo "  export DASHBOARD_API_KEY=\"<derselbe-Wert-wie-auf-dem-Server>\""
echo "  # alternativ: export API_ACCESS_TOKEN=\"...\""
echo "  storage-dashboard-cli dashboard"
echo ""
